...
import moco.loader_lc as m_loader
import moco.builder
import moco.dataset
import utils
import logging
...
def main_worker(index, args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if ((args.distributed and args.rank == 0) or (args.index == 0)) and (epoch==args.epochs-1):
...
def create_data_loader(args):
    ...
    if args.aug_plus:
        ...
        augmentation = [
            ...
            transforms.RandomApply([m_loader.GaussianBlur([.1, 2.])], p=0.5),
    ...
    train_dataset = moco.dataset.FileListDataset(
        args.data,
        m_loader.TwoCropsTransform(transforms.Compose(augmentation)))
